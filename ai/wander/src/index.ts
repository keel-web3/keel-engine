// ai/wander: one animal on its own -- meander, stand and look about, sit,
// bolt from a threat. Provides ai/animal@1.0.0; bound to bodies by contract
// (it needs contract:body/quadruped@^1 and reads only what that contract
...
import { DEFAULTS, MODULE, createBrain, paramsFor } from "./wander.ts";
import type { WanderParams } from "./wander.ts";

export type { Agent, AnimalAi, AnimalMode, Brain, BrainSave, Neighbour, Obstacle, SocketSizes, Vec3, WorldQuery } from "./contract.ts";
export { DEFAULTS, MODULE, createBrain, paramsFor, stepWander } from "./wander.ts";
export type { WanderMemory, WanderParams } from "./wander.ts";
...
export const ai: AnimalAi<WanderParams> = Object.freeze({ contract: "ai/animal@1.0.0", id: MODULE, social: false, defaults: DEFAULTS, createBrain, paramsFor });
