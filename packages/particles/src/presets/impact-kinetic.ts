...
export default defineParticleRecipe({
  ...
  also: [{
    ...
    particle: { life: [0.25, 0.45], size: [0.12, 0.2], sizeCurve: [0.6, 1.2], light: [0.5, 0.75], alpha: [0.9, 0.5, 0], ramp: "dust", soft: 0.5, shade: 0.4, drag: 3, gravity: -0.2, wind: 0.5, turbulence: 0.35 },
  }],
});
