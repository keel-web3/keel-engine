...
export default defineParticleRecipe({
  ...
  also: [
    ...
    },
    {
      ...
      particle: { life: [0.4, 0.7], size: [0.25, 0.4], sizeCurve: [0.6, 1, 1.2], light: [0.7, 0.85], alpha: [0.8, 0.6, 0], ramp: "dust", sprite: "puff", soft: 0.6, shade: 0.4, drag: 3, gravity: -0.2, wind: 0.5, turbulence: 0.35 },
    },
  ],
});
