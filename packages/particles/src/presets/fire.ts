...
export default defineParticleRecipe({
  ...
  particle: {
    ...
    sub: [{
      ...
      emit: { mode: "burst", count: [1, 1], shape: "point", speed: [0, 0.2], up: [0.4, 0.8], priority: 0, reach: 6, particle: { life: [1, 1.8], size: [0.3, 0.5], sizeCurve: [0.6, 1.5], light: [0.3, 0.5], alpha: [0.8, 0.5, 0], ramp: "smoke", soft: 0.5, shade: 0.5, drag: 0.8, gravity: -0.4, wind: 1 } },
    }],
  },
  also: ["embers"],
});
