...
export default defineParticleRecipe({
  ...
  particle: {
    ...
    sub: [{
      ...
      emit: { mode: "burst", count: [1, 1], shape: "point", speed: [0, 0.1], up: [0.3, 0.6], priority: 0, reach: 1, particle: { life: [0.6, 1], size: [0.1, 0.16], sizeCurve: [0.5, 1.3], light: [0.5, 0.8], alpha: [0.7, 0.4, 0], ramp: "ichor", drag: 2, gravity: -0.3, wind: 0.8, turbulence: 0.2 } },
    }],
  },
});
