...
export default defineParticleRecipe({
  ...
  particle: {
    ...
    sub: [{
      ...
      emit: { mode: "burst", count: [1, 1], shape: "point", speed: [0, 0.1], up: [0.3, 0.6], priority: 0, reach: 1, particle: { life: [0.5, 0.9], size: [0.1, 0.16], sizeCurve: [0.5, 1.3], light: [0.55, 0.85], alpha: [0.7, 0.4, 0], ramp: "acid", drag: 2, gravity: -0.3, wind: 0.8 } },
    }],
  },
  also: [{
    mode: "continuous", rate: 10, duration: 0.8, shape: "disc", radius: 0.25, speed: [0, 0.1], up: [0.3, 0.6], priority: 1, budget: 10, reach: 2,
    particle: { life: [0.5, 0.9], size: [0.1, 0.18], sizeCurve: [0.5, 1.2, 1.4], light: [0.5, 0.8], alpha: [0.7, 0.5, 0], ramp: "acid", drag: 2, gravity: -0.3, wind: 0.8 },
  }],
});
