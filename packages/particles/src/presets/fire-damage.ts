    ...
    sub: [
      {
        ...
        emit: { mode: "burst", count: [1, 1], shape: "point", speed: [0, 0.2], up: [0.4, 0.8], priority: 0, reach: 6, particle: { life: [0.8, 1.3], size: [0.2, 0.32], sizeCurve: [0.6, 1.4], light: [0.2, 0.4], alpha: [0.8, 0.5, 0], ramp: "smoke", sprite: "puff", soft: 0.5, shade: 0.5, drag: 0.8, gravity: -0.4, wind: 1 } },
      },
      {
        on: "live", rate: 1.5, inherit: 0.4,
        emit: { mode: "burst", count: [1, 1], shape: "point", speed: [0.1, 0.3], up: [0.6, 1.4], priority: 1, reach: 5, particle: { life: [0.9, 1.6], size: [0.04, 0.07], light: [0.7, 1], lightCurve: [1, 0.8, 0.5], alpha: [1, 1, 0.8, 0], ramp: "ember", drag: 0.8, gravity: -0.4, wind: 0.9, curl: 1.5 } },
      },
    ],
  },
});
