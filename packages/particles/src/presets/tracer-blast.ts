...
export default defineParticleRecipe({
  ...
  particle: {
    ...
    sub: [{
      ...
      emit: { mode: "burst", count: [1, 1], shape: "point", speed: [0, 0.1], up: [0.1, 0.3], priority: 0, reach: 3, particle: { life: [0.35, 0.65], size: [0.16, 0.26], sizeCurve: [0.6, 1.3], light: [0.35, 0.6], alpha: [0.85, 0.5, 0], ramp: "smoke", soft: 0.4, drag: 2, gravity: -0.3, wind: 0.6, turbulence: 0.6 } },
    }],
  },
});
