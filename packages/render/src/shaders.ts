// The realtime pixel pipeline's shaders (WebGL2 / GLSL ES 3.00) -- ported
// from the proof of concept's src/gpu/shaders.js. The GLSL is the proof of
// concept's, character for character (test/poc-equality.test.ts checks every
// string): change it there and here together, or not at all.
//
...
// The fx (fx.ts) run here too, all at the target size and all on the ramps:
