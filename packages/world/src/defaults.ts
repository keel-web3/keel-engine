...
// "auto" means "the target rules decide" (./rules.ts).
//
...
//   species, pins.*     ITEMS: what generation must use (see README)

import type { LayerValues } from "./config.ts";

export const ENGINE_DEFAULTS: Readonly<LayerValues> = Object.freeze({
  // Filters.
  ...
  "render.rampLength": "auto", //    entries per ramp, "full", or "auto" (core rampBudget)
