// The KEEL build: packs/dungeon bundles into one KEEL module that reaches only
// keel/object and keel/runtime (every engine import a lookup through its context), never
