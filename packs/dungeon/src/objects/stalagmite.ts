...
export default defineStyledObject({
  ...
  design(J, v) {
    ...
    for (let i = 0; i < n; i += 1) {
      ...
      solids.push(solid.ball("stone", [Math.sin(a) * d, h * 0.16, Math.cos(a) * d], [r * 1.1, h * 0.16, r], { name: "foot", collide: false }));
      solids.push(solid.cone("stone", [Math.sin(a) * d, h * 0.1, Math.cos(a) * d], r * 0.85, h * 0.9, r * 0.12, { name: "spike", sides: 8, steps: 2 }));
    }
