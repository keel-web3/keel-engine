...
// are keel/bake's indexed designs and layer paints -- types only, so it needs keel/core alone at runtime.)
export const manifest = defineManifest({
  id: PACK_ID,
  version: PACK_VERSION,
  kind: "pack",
  needs: ["keel/runtime@^0.1", "keel/core@^0.1", "keel/vehicle@^0.1"],
